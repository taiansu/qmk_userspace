...
static bool process_modifier_key(keyrecord_t *record, uint8_t mods) {
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case HYPER_MOD:
            return process_modifier_key(record, MOD_HYPR);
        case MEH_MOD:
            return process_modifier_key(record, MOD_MEH);
        case CAG_MOD:
            return process_modifier_key(record, MOD_LCTL | MOD_LALT | MOD_LGUI);
        case PTT_MOD:
            return process_modifier_key(record, MOD_LCTL | MOD_LALT);
    }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_91_ansi(
        ...
        MEH(KC_SPC),   KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,    KC_EQL,   KC_BSPC,            KC_PGUP,
        HYPER_MOD,     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,    KC_RBRC,  KC_BSLS,            KC_PGDN,
        MEH_MOD,       KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_HOME,
        CAG_MOD,       KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        PTT_MOD,       KC_GLOBE, KC_LCTL,  KC_LOPT,  KC_LCMD,            KC_SPC,                        KC_SPC,             KC_RCMD,  KC_RCTL, MO(MAC_FN),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_91_ansi(
        ...
        MEH_MOD,       KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,             KC_HOME,
        CAG_MOD,       KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        PTT_MOD,       MO(WIN_FN), KC_LCTL, KC_LALT, KC_LWIN,            KC_SPC,                        KC_SPC,             KC_RWIN,  KC_RCTL, MO(WIN_FN),  KC_LEFT,  KC_DOWN,  KC_RGHT),
